...
// 2) Create a class with a method which generates a fibonacci sequence
// 3) Create a class with a method which checks if the given value is a palindrome or not
